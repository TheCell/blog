...
So we can now link to our fixed header: [https://our-fancy-website.ch/home#my-unique-id](https://our-fancy-website.ch/home#my-unique-id)
That looks pretty awesome and the unique Id can help us in various situations, not only for HTML ids. You can use it in typescript to just keep track of objects etc. The sky is the limit.